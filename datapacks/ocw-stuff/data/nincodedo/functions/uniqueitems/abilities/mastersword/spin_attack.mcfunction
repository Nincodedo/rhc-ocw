...
data merge entity @e[tag=spin_attack_sword,sort=nearest,limit=1] {transformation:{scale:[2f,2f,2f],translation:[.50f,-.50f,.50f],right_rotation:{angle:3.75f,axis:[0,1,0]}},start_interpolation:-1}

...
execute at @p[tag=spin_attacker] as @e[distance=..3,tag=!spin_attack,tag=!spin_attacker] run damage @s 3.5 nincodedo:sword_spin_attack by @e[tag=spin_attack_sword,sort=nearest,limit=1] from @p[tag=spin_attacker]

...
execute at @p[tag=spin_attacker] as @e[distance=1..3,tag=!spin_attack] run damage @s 2.5 nincodedo:sword_spin_attack by @e[tag=spin_attack_sword,sort=nearest,limit=1] from @p[tag=spin_attacker]

execute as @a[scores={ascend_phase=2}] at @s if block ~ ~1 ~ air if block ~ ~2 ~ air run scoreboard players set @s ascend_phase 3
execute as @a[scores={ascend_phase=2}] at @s run tp ~ ~1 ~

...
execute as @a[scores={ascend_phase=0}] at @s if score @s ascend_initial_bg_loop matches 60 run playsound nincodedo:item.ascend.initial_activate_bg_loop player @s ~ ~ ~ 1 1

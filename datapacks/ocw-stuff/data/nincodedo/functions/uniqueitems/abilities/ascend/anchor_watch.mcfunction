...
execute on vehicle if entity @s[tag=ascend_anchor] on passengers run scoreboard players set @s ascend_anchor_check 1
execute if score @s ascend_anchor_check matches 0 run scoreboard players set @s ascend_phase 5
execute if score @s ascend_anchor_check matches 0 run kill @e[tag=ascend,sort=nearest,limit=1]

...
execute as @a[predicate=nincodedo:isentityundeadzeratul,nbt={Inventory:[{Slot:103b,tag:{NinUnique:"UG",NinPowered:1}}]}] run effect give @s minecraft:night_vision 30

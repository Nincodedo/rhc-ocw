...
execute as @e[tag=stealth_strike_counter] if score @s moon_dagger_effect matches ..0 run data modify entity @s[type=!minecraft:text_display] NoAI set value false

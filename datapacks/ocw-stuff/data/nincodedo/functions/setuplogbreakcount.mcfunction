scoreboard objectives add acacia_log_break minecraft.mined:minecraft.acacia_log
scoreboard objectives add birch_log_break minecraft.mined:minecraft.birch_log
scoreboard objectives add drk_oa_log_break minecraft.mined:minecraft.dark_oak_log
